...
const MemeCard = ({ meme }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-gray-500 dark:bg-white rounded-xl shadow-lg overflow-hidden "
    >
      {/* Header */}
      ...
      ">
        ...
        <div className="ml-3">
          <p className="font-medium text-gray-500 dark:text-gray-900">{meme.name}</p>
      ...
      {/* Actions */}
      <div className="p-4">
        <div className="flex items-center space-x-4 text-gray-500 dark:text-gray-900">
          <motion.button
            whileTap={{ scale: 0.9 }}
            onClick={handleLike}
