...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className=" fixed bottom-0 left-0 w-full  dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 z-50">
        <div className="flex w-full">
          {navItems.map((item) => (
            ...
            >
              <div className="flex flex-col items-center p-2 text-white hover:text-gray-900">
